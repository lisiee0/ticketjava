					...
					<div class="row">
						<div class="col-xs-5 counter-item zp">
							<p style="font-size:27px; color:#aaa; font-weight:900; line-height:1.5em; margin-top:15px">지금까지 
								<span class="counter" data-to="12345" data-speed="1000" style="font-size:27px; color:#555; font-weight:900;">1000</span><span style="color:black;">분</span>이<br>
								티켓자바를 통해<br> 
								원하는 작품을 만나셨어요!
							</p>
						</div>
						...
						<div class="col-xs-5 counter-item zp"">
							<p style="font-size:27px; color:#aaa; font-weight:300; line-height:2.5em;">
								티켓자바와 함께 한 누적 시간<br>
								<span class="counter" data-to="123455678" data-speed="1000" style="font-size:65px; color:#555; font-weight:900;">10000</span><span style="font-size:65px; color:#555; font-weight:900;">분</span>
							</p>
						</div>
					</div>
