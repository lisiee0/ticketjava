...
<link href="assets/css/login/modifyForm.css" rel="stylesheet">
<link href="assets/css/login/mypageUserOut.css" rel="stylesheet">
...
<body>
	<div id="wrap">
		...
		<div class="userOutnotice">
			<div><h3>이용에 불편을 드려 죄송합니다</h3></div>
			<div><h4>회원탈퇴시 혜택은 소멸하고, 가입정보는 즉시 파기되어 복구불가 합니다.</h4></div>
		</div>	
					...
					<tr>
						<td colspan="4">
							<label class="checkbox-inline">
							  <input type="checkbox" value="option1"> 탈퇴에 동의 하시면 체크박스를 선택 해주세요.
							</label>
						</td>
					</tr>
					<tr>
