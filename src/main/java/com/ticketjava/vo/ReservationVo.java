...
public class ReservationVo {
	...
	public ReservationVo(int rezNo, int prodNo, int userNo, int ticketCount, String rezDate, String viewDate,
	...
	public String toString() {
		return "ReservationVo [rezNo=" + rezNo + ", prodNo=" + prodNo + ", userNo=" + userNo + ", ticketCount="
				+ ticketCount + ", rezDate=" + rezDate + ", viewDate=" + viewDate + ", phone=" + phone + ", email="
				+ email + ", status=" + status + "]";
	}
